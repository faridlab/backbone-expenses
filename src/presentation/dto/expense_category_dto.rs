//! ExpenseCategory DTOs (Data Transfer Objects)
//!
...
/// Request DTO for creating a new ExpenseCategory
///
...
pub struct CreateExpenseCategoryDto {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", alias = "default_tax_rate")]
...
/// Request DTO for full update of a ExpenseCategory
///
...
/// Request DTO for partial update of a ExpenseCategory
///
...
pub struct PatchExpenseCategoryDto {
    ...
    #[serde(skip_serializing_if = "Option::is_none", alias = "default_tax_rate")]
    pub default_tax_rate: Option<Decimal>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}
...
/// Response DTO for ExpenseCategory entity
///
...
/// Paginated list response for ExpenseCategory entities
///
...
#[cfg_attr(feature = "openapi", derive(ToSchema))]
#[serde(rename_all = "camelCase")]
pub struct ExpenseCategoryListResponseDto {
    /// List of items
    pub items: Vec<ExpenseCategoryResponseDto>,
...
impl ExpenseCategoryListResponseDto {
    /// Create a new list response from items and pagination info
    pub fn new(items: Vec<ExpenseCategoryResponseDto>, total: u64, page: u32, per_page: u32) -> Self {
...
impl From<ExpenseCategory> for ExpenseCategoryResponseDto {
...
impl From<ExpenseCategory> for ExpenseCategorySummaryDto {
    fn from(entity: ExpenseCategory) -> Self {
...
impl From<CreateExpenseCategoryDto> for ExpenseCategory {
...
impl backbone_core::FromCreateDto<CreateExpenseCategoryDto> for ExpenseCategory {
    fn from_create_dto(dto: CreateExpenseCategoryDto) -> backbone_core::ServiceResult<Self> {
        Ok(ExpenseCategory::from(dto))
    }
}
