//! Specifications for Expense aggregate
//!
...
// Each predicate implements `Specification<Expense>` and can be combined
...
//
// pub struct ActiveExpenseSpec;
// impl Specification<Expense> for ActiveExpenseSpec {
//     fn is_satisfied_by(&self, e: &Expense) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
