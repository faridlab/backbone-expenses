//! Specifications for ExpenseTaxLine aggregate
//!
...
// Each predicate implements `Specification<ExpenseTaxLine>` and can be combined
...
//
// pub struct ActiveExpenseTaxLineSpec;
// impl Specification<ExpenseTaxLine> for ActiveExpenseTaxLineSpec {
//     fn is_satisfied_by(&self, e: &ExpenseTaxLine) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
