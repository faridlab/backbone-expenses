//! Domain policy for ExpenseCategory aggregate
//!
...
/// Domain policy for ExpenseCategory — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<ExpenseCategory>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type ExpenseCategoryDomainPolicy = PermitAllPolicy<ExpenseCategory>;
